...
## Overview
The 369 Art Collective now features an automatic template assignment system that prepares the platform for expansion beyond art prints to other POD product categories (apparel, accessories, etc.).
