...
- **Shopify Integration:** Automated product creation, order capture via HMAC-verified webhooks (including idempotency for purchases), enriched product creation, and automated theme/navigation deployment.
