...
/**
 * This script updates Shopify products to include frame color variants:
 * - Paper, Canvas, Metal (unchanged)
 * - Framed-Black, Framed-White, Framed-Walnut (new frame variants)
 */
...
// Updated finish structure with frame colors
const FINISHES = {
...
async function updateAllProducts() {
  console.log("\n🎨 Adding Frame Color Variants to Shopify Products\n");
  console.log("=".repeat(60));
  console.log("\nNew finish options:");
  console.log("  • Paper (Matte paper) - $19-76");
  console.log("  • Canvas (Stretched) - $39-156");
  console.log("  • Framed-Black (Black frame) - $49-196");
  console.log("  • Framed-White (White frame) - $49-196");
  console.log("  • Framed-Walnut (Walnut frame) - $49-196");
  console.log("  • Metal (Metal art) - $59-236");
  console.log("\n" + "=".repeat(60));
  ...
  for (let i = 0; i < products.length; i++) {
    ...
    // Generate new variants with frame colors
    ...
    const newTags = [
      ...nonFinishTags,
      ...Array.from(new Set(Object.values(FINISHES).map(f => f.tag))), // Deduplicate Finish:Framed
    ];
  ...
  console.log("\n" + "=".repeat(60));
  console.log("✅ COMPLETE - Frame color variants added!");
  console.log("=".repeat(60) + "\n");
}
